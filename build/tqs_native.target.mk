...
OBJS := \
	...
	$(obj).target/$(TARGET)/native/src/maybefetch.o
...
$(builddir)/tqs_native.node: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(builddir)/tqs_native.node: LIBS := $(LIBS)
$(builddir)/tqs_native.node: GYP_LIBTOOLFLAGS := $(LIBTOOLFLAGS_$(BUILDTYPE))
$(builddir)/tqs_native.node: TOOLSET := $(TOOLSET)
$(builddir)/tqs_native.node: $(OBJS) FORCE_DO_CMD
	$(call do_cmd,solink_module)

all_deps += $(builddir)/tqs_native.node
# Add target alias
.PHONY: tqs_native
tqs_native: $(builddir)/tqs_native.node

# Short alias for building this executable.
.PHONY: tqs_native.node
tqs_native.node: $(builddir)/tqs_native.node

# Add executable to "all" target.
.PHONY: all
all: $(builddir)/tqs_native.node
